...
extension Token {
    ...
    private static func makeTokenGenerators() -> [TokenGenerator] {
        ...
        generators.append(TokenGenerator(regex: "while", resolver: { _ in [.whileLoop] }))
        generators.append(TokenGenerator(regex: "for", resolver: { _ in [.forLoop] }))
        ...
        generators.append(TokenGenerator(regex: "and", resolver: { _ in [.andOperator] }))
        generators.append(TokenGenerator(regex: "\\|\\|", resolver: { _ in [.orOperator] }))
        generators.append(TokenGenerator(regex: "or", resolver: { _ in [.orOperator] }))
